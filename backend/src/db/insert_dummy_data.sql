...
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Emily Davis', 'emily.davis@example.com', 4, 'ACTIVE');
INSERT INTO employees (name, email_id, department_id, status) VALUES ('David Wilson', 'david.wilson@example.com', 5, 'ACTIVE');
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Sophia Brown', 'sophia.brown@example.com', 6, 'ACTIVE');
...
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Benjamin Harris', 'benjamin.harris@example.com', 3, 'ACTIVE');
...
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Mia Garcia', 'mia.garcia@example.com', 6, 'ACTIVE');
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Henry Clark', 'henry.clark@example.com', 7, 'ACTIVE');
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Amelia Lewis', 'amelia.lewis@example.com', 8, 'ACTIVE');
INSERT INTO employees (name, email_id, department_id, status) VALUES ('Ethan Walker', 'ethan.walker@example.com', 9, 'ACTIVE');
